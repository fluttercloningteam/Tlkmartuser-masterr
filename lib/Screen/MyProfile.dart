...
import 'package:tlkmartuser/Helper/Public%20Api/api.dart';
...
import 'package:tlkmartuser/Screen/Customer_Support.dart';
import 'package:tlkmartuser/Screen/MyLoyalty.dart';
import 'package:tlkmartuser/Screen/MyTransactions.dart';
import 'package:tlkmartuser/Screen/ReferEarn.dart';
import 'package:tlkmartuser/Screen/SendOtp.dart';
import 'package:tlkmartuser/Screen/Setting.dart';
...
class StateProfile extends State<MyProfile> with TickerProviderStateMixin {
  ...
  // List<String> langCode = ["en", "hi", "zh", "es", "ar", "ru", "ja", "de","te"];
  List<String> langCode = ["en","hi","te"];
    ...
    return Card(
      ...
      child: ListTile(
        ...
        title: Text(
          title,
          style: TextStyle(
              color: Theme.of(context).colorScheme.lightBlack, fontSize: 16,fontWeight: FontWeight.bold),
        ),
        onTap: () async{
          if (title == getTranslated(context, 'MY_ORDERS_LBL')) {
            ...
            Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => MyLoyalityHistoryWidget(),
                ));
          } else if (title == getTranslated(context, 'LOYALTY')) {
            Navigator.push(
                context,
                MaterialPageRoute(
