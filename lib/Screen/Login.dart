...
// // import 'package:tlkmartuser/Screen/SignUp.dart';
...
// import 'package:tlkmartuser/Provider/SettingProvider.dart';
// import 'package:tlkmartuser/Provider/UserProvider.dart';
// import 'package:tlkmartuser/Screen/Privacy_Policy.dart';
// import 'package:tlkmartuser/Screen/Verify_Otp.dart';
// import 'package:flutter/cupertino.dart';
// import 'package:flutter/material.dart';
// import 'package:flutter/services.dart';
// import 'package:flutter_svg/flutter_svg.dart';
...
class _LoginPageState extends State<Login> with TickerProviderStateMixin {
  ...
  //                               groupValue: login,
  //                               onChanged: (value) {
  //                                 updateLoginType(value.toString());
  //                               },
  //                               activeColor: colors.primary,
  //                             ),
  //                             Text(
  //                               '${getTranslated(context, 'LOGIN_WITH_PASSWORD')}',
  //                               style: TextStyle(
  ...
  //                             ),
  //                             Text(
  //                               '${getTranslated(context, 'LOGIN_WITH_MOBILE')}',
  //                               style: TextStyle(
  //                                   color: Colors.black, fontSize: 15),
  //                             )
  //                           ],
  ...
  Future<void> loginWithMobile() async {
    ...
    request.fields.addAll({'mobile': "${mobile.toString()}"});
    ...
    if (response.statusCode == 200) {
      ...
      if (finalresult['error'] == false) {
        await buttonController!.reverse();
        setSnackbar(msg);
        String otp = finalresult['otp'].toString();
